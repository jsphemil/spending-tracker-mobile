...
| §5.20 | New Home Screen Widgets (Quick Add / Cash Flow / Net Worth) | ⏸️ Deferred | **Started 2026-09-05.** Widget A (Quick Add Transaction) + launcher shortcuts ✅ Built & Verified 2026-09-06, shipped 2026-09-09 as versionCode 14, release `Erebor_WM14(2.1.0)`. **Widget B (Monthly Cash Flow) ❌ Dropped 2026-09-09** — removed from the codebase entirely after its "Today" row bug went unresolved through 3 fix attempts; never shipped. **Widget C (Net Worth & Financial Composition) still ⏸️ Deferred, undecided** — scope agreed, no code written. See §5.20 for full scope and Widget B's debugging trail. |
